...
import com.ringme.base.dto.app.request.AssignMenusRequest;
import com.ringme.base.dto.app.request.AssignPermissionsRequest;
...
import com.ringme.base.service.RoleAssignmentService;
import com.ringme.base.service.RoleService;
 ...
 * {@code rbac:manage} (seed sẵn trong sql/oracle/rbac.sql, khớp {@code /v1/rbac/**}) là lớp kiểm tra thứ 2.
 */
@RestController
