...
import com.ringme.base.enums.MenuType;
...
/**
 * Ánh xạ bảng {@code dev_e_commerce.menu} — cây điều hướng UI, ĐỘC LẬP hoàn toàn với Permission
...
@Setter
@Entity
@Table(name = "menu", schema = "dev_e_commerce")
public class Menu {
