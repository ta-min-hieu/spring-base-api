...
import com.ringme.base.iam.repository.projection.PermissionResourceProjection;
...
public interface RolePermissionRepository extends JpaRepository<RolePermission, Long> {
    ...
    @Query("select p.code as code, p.httpMethod as httpMethod, p.urlPattern as urlPattern " +
            ...
            "where r.roleKey = :roleKey and r.status = com.ringme.base.iam.enums.CommonStatus.ACTIVE " +
            "and p.status = com.ringme.base.iam.enums.CommonStatus.ACTIVE")
