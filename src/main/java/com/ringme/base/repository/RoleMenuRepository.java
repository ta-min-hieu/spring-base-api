...
public interface RoleMenuRepository extends JpaRepository<RoleMenu, Long> {
    ...
    @Query("select distinct rm.menu from RoleMenu rm " +
            "where rm.role.roleKey in :roleKeys and rm.role.status = com.ringme.base.enums.CommonStatus.ACTIVE " +
            "and rm.menu.status = com.ringme.base.enums.CommonStatus.ACTIVE")
