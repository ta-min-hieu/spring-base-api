...
import com.ringme.base.repository.RoleRepository;
import com.ringme.base.repository.UserRoleRepository;
import com.ringme.base.service.UserRoleService;
...
/**
 * Gán Role (module RBAC, bảng dev_e_commerce.role) cho AppUser. userId chỉ được validate TỒN TẠI qua
 ...
 * sql/oracle/rbac.sql. Đồng bộ cả 2 nếu muốn user vừa login được vừa đúng RBAC ngay từ token /v1/auth/login.
 */
@Service
